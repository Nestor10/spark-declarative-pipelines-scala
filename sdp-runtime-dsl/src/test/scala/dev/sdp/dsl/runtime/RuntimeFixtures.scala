...
/** The Warehouse example built with the RUNTIME plan-builder. Bodies are
  * line-for-line the macro fixtures' bodies; only the import differs
  * (`dev.sdp.dsl.runtime.*` instead of `dev.sdp.dsl.*`).
  *
